...
public class KuasoWorld {
    ...
    //方块注册器
    // Create a Deferred Register to hold Blocks which will all be registered under the "kuasoworld" namespace
    public static DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "kuasoworld" namespace

    //物品注册器
    public static DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MODID);

    // Creates a new Block with the id "examplemod:example_block", combining the namespace and path
//    public static final RegistryObject<Block> RAW_KUASO = ITEMS.register("raw_kuaso", () -> new Item());
